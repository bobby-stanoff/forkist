...
class RecipeView extends View {
  ...
  _generateMarkup() {
    return `
      <figure class="recipe__fig">
        <img src="${this._data.image.slice(0,this._data.image.indexOf("Ch_169"))}52${this._data.image.slice(this._data.image.indexOf("Ch_169"),this._data.image.length)}" alt="${this._data.title
      }" class="recipe__img" />
      ...
      <div class="recipe__directions">
        ...
        <ul class="recipe__preparation-list">
          ${this._data.preparation.map(this._generateMarkupPreparation).join('')}
        </ul>
  ...
  _generateMarkupPreparation(prep) {
    return `
      <li class="recipe__preparation">
        <svg class="recipe__icon">
          <use href="${icons}#icon-check"></use>
        </svg>
        <div class="recipe__description">
